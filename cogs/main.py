...
class Main(commands.Cog):
	...
	async def asd(self, ctx):
		emb = discord.Embed(title = 'Правила нашего дискорд сервера', description = '```Текстовые```\n**1.7 Несоблюдение тематики чата** - наказание: мут до 2х часов\n\n**1.8 Капс, спам, флуд в любых его проявлениях** - наказание: мут до 2х часов\n\n**1.9 Неадекватное поведение, завуалированные оскорбления/провокации** - наказание: мут до 2х часов\n\n**2.0 Беспричинное упоминание пользователей или ролей** - наказание: мут до 2х часов', colour = discord.Color.from_rgb(48,52,52))
