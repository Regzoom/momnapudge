...
class Main(commands.Cog):
	...
	async def asd(self, ctx):
		emb = discord.Embed(title = '', description = '```Чтобы открыть все каналы получи роли нажав на реакцию```\n<:2036_dota2:998851676435918848> - открывает каналы доты.\n<:861763007860f1522e0eadf992432a02:998851753866952734>- открывает каналы раста. ', colour = discord.Color.from_rgb(48,52,52))
