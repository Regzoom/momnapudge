...
class Main(commands.Cog):
	...
	async def asd(self, ctx):
		emb = discord.Embed(title = 'Ивент', description = '``` ``` Разыгрываю кастомную роль, типу который пригласит больше всех новых участников на сервер получит кастомную роль(будет называться как он хочет, такого цвета как он захочет)\n ``` ```\nитоги где-то через недельку сделаю.\n\n Всем удачи', colour = discord.Color.from_rgb(48,52,52))
